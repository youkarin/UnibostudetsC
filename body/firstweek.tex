...
\includegraphics[scale=0.5]{c.f.moduloqrcode}\\
%%（https://www.agenziaentrate.gov.it/portale/documents/20143/278893/modello+cf+AA48_modello+AA4+8.pdf/a8287f7f-abcf-c4f9-b4f7-f038486bc7d6)
\\
...
\\
\includegraphics[scale=0.4]{c.f.uniboqrcode}\\
%%（https://www.unibo.it/it/servizi-e-opportunita/borse-di-studio-e-agevolazioni/il-codice-fiscale-italiano）
\section{医疗保险}
...
%%（https://ww2.ausl.bologna.it/iap_dati/view_book_acc_mode?&ModPrenotazCupProvinciale=1）
\item 按工作人员的指示前往缴费。
...
\\
\includegraphics[scale=0.4]{csmqrcode}\\
%%（https://guidaservizi.fascicolo-sanitario.it/dettaglio/luogo/3155459/3152808）
